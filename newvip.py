...
# Form implementation generated from reading ui file 'newvip.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButton_NewVip = QtWidgets.QPushButton(self.splitter_3)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.pushButton_NewVip.setFont(font)
        self.pushButton_NewVip.setObjectName("pushButton_NewVip")
        ...
        self.pushButton_Delete = QtWidgets.QPushButton(self.splitter_3)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.widget.setGeometry(QtCore.QRect(110, 73, 133, 241))
        ...
        self.dateEdit_Birthday = QtWidgets.QDateEdit(self.widget)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.lineEdit_lesson = QtWidgets.QLineEdit(self.widget)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lineEdit_lesson.setFont(font)
        self.lineEdit_lesson.setObjectName("lineEdit_lesson")
        self.verticalLayout.addWidget(self.lineEdit_lesson)
        self.dateEdit_Add = QtWidgets.QDateEdit(self.widget)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.dateEdit_Add.setFont(font)
        self.dateEdit_Add.setObjectName("dateEdit_Add")
        self.verticalLayout.addWidget(self.dateEdit_Add)
        self.lineEdit_expire = QtWidgets.QLineEdit(self.widget)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lineEdit_expire.setFont(font)
        self.lineEdit_expire.setObjectName("lineEdit_expire")
        self.verticalLayout.addWidget(self.lineEdit_expire)
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_NewVip.setText(_translate("Form", "加入"))
        self.pushButton_UpData.setText(_translate("Form", "修改"))
        self.pushButton_Delete.setText(_translate("Form", "移除"))
        ...
        self.lineEdit.setText(_translate("Form", "會  員  註  冊"))
